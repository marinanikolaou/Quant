...
**Project 1**
Return & Risk Calculator that takes up to four user-specified stock tickers, pulls their historical price data from Yahoo Finance, and computes three core quantitative metrics: 
  - annualized return (simple and log)
